...
We identified a statistically significant difference between the longest genre (crime) in movie durations and the shortest (Family) suggesting that the average duration of a movie may vary depending on the genre. 

Trends in Movie Duration Vary Across Genres Over time
